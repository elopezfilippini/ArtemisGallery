function Presentacion() {
    return (<div className="mt-10">
      <div className="w-[375px] relative md:w-full bg-purple-400 bg-opacity-40 border-1 rounded-full flex justify-center">
        
        
        <h1 className="text-3xl font-caveat md:text-5xl">
            Mi nombre es Artemis y mi pasión es el arte, espero te gusten mis dibujos
            y seleccion de pelis y moda....</h1></div>
