    ...
    <div className='mt-5 mb-5'>
      <div className="flex justify-center items-center">
        <LiaChevronCircleLeftSolid
          ...
          className="text-blue-900 md:text-[70px] text-[53px]cursor-pointer hover:text-purple-500"
        />
      </div>
      <h1 className='font-caveat text-4xl md:text-7xl text-center mt-4'>" {monstruo.titulo} "</h1>
      <div className="flex justify-center mt-4">
        <img className="object-contain max-w-[375px]  md:max-w-full" src={monstruo.ruta} alt={`Foto ${id}`} />
      </div>
      <span></span>
    </div>
  );
